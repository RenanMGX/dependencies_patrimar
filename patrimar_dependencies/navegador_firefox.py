...
class NavegadorFirefox(Firefox):
    ...
    """
    Classe que estende o navegador Firefox, adicionando configurações personalizadas.
    """
    def __init__(self, 
        ...
        Fluxo Detalhado:
          ...
          2. Configura as preferências do Firefox para utilizar o diretório de downloads.
          3. Se 'save_user' for True, adiciona argumento para manter dados do usuário.
          4. Chama o construtor da classe base Firefox, passando as opções configuradas.
        ...
        Args:
            options (Union[Options, None]): Opções avançadas para o Firefox.
            service: Serviço que controla o FirefoxDriver.
...
if __name__ == "__main__":
    bot = NavegadorFirefox(speak=False, download_path="C:\\Users\\Patrimar\\Downloads", headless=False)
