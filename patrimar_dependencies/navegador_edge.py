...
class NavegadorEdge(Edge):
    ...
    """
    Classe que estende o navegador Edge, adicionando configurações personalizadas.
    """
    def __init__(self, 
        ...
        Fluxo Detalhado:
          ...
          2. Configura as preferências do Edge para utilizar o diretório de downloads.
          3. Se 'save_user' for True, adiciona argumento para manter dados do usuário.
          4. Chama o construtor da classe base Edge, passando as opções configuradas.
        ...
        Args:
            options (Union[Options, None]): Opções avançadas para o Edge.
            service: Serviço que controla o EdgeDriver.
...
if __name__ == "__main__":
    bot = NavegadorEdge(speak=False, download_path="C:\\Users\\Patrimar\\Downloads", headless=False)
