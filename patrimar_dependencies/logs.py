...
class Logs_old:
    ...
    def __init__(self, name:str=os.environ['project_name'], *, path_folder:str=os.path.join(os.getcwd(), 'Logs'), hostname:str=Config()['log']['hostname'], port:str=Config()['log']['port']) -> None:
        try:
            token = os.environ['central_rpa_token']
        except:
            token = ""
